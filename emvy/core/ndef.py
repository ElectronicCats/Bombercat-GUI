...
_TNF_NAMES = {
    ...
    TNF_MIME: "MIME",
    TNF_URI: "URI",
    TNF_EXTERNAL: "externo",
    TNF_UNKNOWN: "desconocido",
...
class NdefRecord:
    ...
    def decoded(self) -> str:
        ...
        return (
            f"[{_TNF_NAMES.get(self.tnf, 'tnf?')} {self.type_str()}] "
...
def card_record(
    pan: str = "", expiry: str = "", track2: str = "", aid: str = "", label: str = ""
) -> bytes:
